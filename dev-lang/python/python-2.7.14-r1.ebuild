...
# Based on https://dl.fedoraproject.org/pub/fedora/linux/development/rawhide/Everything/source/tree/Packages/p/python2-2.7.14-13.fc29.src.rpm
...
src_prepare() {
	...
	for patch in $(grep -Ev "^#" "${FILESDIR}/${PV}"/series | cut -d ' ' -f1 2> /dev/null); do
